  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm">
      ...
      >
        ...
        <div className="absolute inset-[9%] flex flex-col items-center justify-between">
          <div className="flex w-full items-center justify-between gap-4 px-2 pt-2 sm:px-4">
          ...
          <button
            ...
            className="relative w-28 h-11 shrink-0 pb-2 transition-transform hover:scale-105 active:scale-95 sm:w-32 sm:h-12"
          >
